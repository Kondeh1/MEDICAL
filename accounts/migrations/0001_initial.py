    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medical_history_summary', models.TextField(blank=True, help_text='Summary of medical history for providers.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('credentials', models.CharField(help_text='Professional credentials (e.g. MD, MBBS).', max_length=255)),
